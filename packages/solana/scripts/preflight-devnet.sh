...
ICHOR_PROGRAM_ID="925GAeqjKMX4B5MDANB91SZCvrx8HpEgmPJwHJzxKJx1"
RUMBLE_ENGINE_PROGRAM_ID="${RUMBLE_ENGINE_PROGRAM_ID:-638DcfW6NaBweznnzmJe4PyxCw51s3CTkykUNskWnxTU}"
FIGHTER_REGISTRY_PROGRAM_ID="${FIGHTER_REGISTRY_PROGRAM_ID:-2hA6Jvj1yjP2Uj3qrJcsBeYA2R9xPM95mDKw1ncKVExa}"
...
PROGRAMS=(
  ...
  "rumble_engine:${RUMBLE_ENGINE_PROGRAM_ID}"
  "fighter_registry:${FIGHTER_REGISTRY_PROGRAM_ID}"
)
